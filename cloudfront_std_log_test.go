	...
	expectedLogs := []cflog2otel.CELVariablesLog{
		{
			...
			Date:                   "2019-12-04",
			Time:                   "21:02:31",
			Timestamp:              must(time.Parse("2006-01-02 15:04:05", "2019-12-04 21:02:31")),
		...
		},
		{
			...
			Date:                   "2019-12-13",
			Time:                   "22:36:27",
			Timestamp:              must(time.Parse("2006-01-02 15:04:05", "2019-12-13 22:36:27")),
		...
		},
		{
			...
			Date:                   "2019-12-13",
			Time:                   "22:36:26",
			Timestamp:              must(time.Parse("2006-01-02 15:04:05", "2019-12-13 22:36:26")),
			EdgeLocation:           ptr("SEA19-C1"),
			ScBytes:                ptr(900),
			ClientIP:               ptr("192.0.2.200"),
			CsMethod:               ptr("GET"),
		...
		},
		{
			...
			Date:                   "2019-12-13",
			Time:                   "22:37:02",
			Timestamp:              must(time.Parse("2006-01-02 15:04:05", "2019-12-13 22:37:02")),
